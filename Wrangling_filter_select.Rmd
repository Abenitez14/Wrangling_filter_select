...
Harry Potter and the Sorcerer's Stone had the most votes overall.
...
movies_2000 <- movies %>%
  filter(Comedy == 1) %>%
  arrange(votes <= 100, desc(budget))
movies_2000
```

 Wild Wild West has the biggest budget adds up to 170000000.
